        ...
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++){
                ...
                if (currentResult.has("webPublicationDate")){
                    publishedDate = currentResult.getString("webPublicationDate");
                }else {
                    publishedDate = "No date of publish";
                }
                // Extract the value for the key called "sectionName"
                if (currentResult.has("sectionName")) {
                    section = currentResult.getString("sectionName");
                }else {
                    section = "Uknown section";
                }
                ...
                // Create a new {@link News} object with the title, date, section
                // and url from the JSON response.
                News News = new News(title, publishedDate, section, url);
